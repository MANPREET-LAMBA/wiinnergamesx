...
export default function Algo(){
    return(
        ...
        <div className="flex flex-col lg:flex-row items-center md:items-start md:justify-evenly">
             <div className=" flex justify-center">
        <img
        className=" w-[70%] md:w-[50%] rounded-2xl"
        src={algoimg}/>
       </div>
       <div className=" w-full pt-4 lg:pt-0  text-black flex flex-col md:items-center lg:items-start md:pt-3 md:px-10 lg:w-[50%] ">
         <p className=" w-full px-9 lg:max-w-3xl   text-xl text-justify  md:px-0 md:text-2xl  lg:text-start mb-6 ">
