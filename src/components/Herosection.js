  ...
  return (
    <div className="w-full h-[90vh] md:h-screen relative">
      ...
      <div className=" absolute ">
        <section className=" h-screen overflow-hidden  lg:h-[80vh] bg-transparent  text-white py-16 text-center flex flex-col items-center lg:flex-row  lg:justify-evenly lg:items-start  w-full lg:px-24">


          <h1 className="text-3xl lg:text-6xl  text-center lg:text-start p-3 font-playfair bg-slate-800 bg-opacity-25 rounded-xl font-extrabold lg:min-w-fit">
